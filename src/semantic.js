...
module.exports = {
  initialize: (function ($, window, document, undefined) {
...
console.log("run");})//( jQuery, window, document );
 ...
 *
 */
, initialize2 : (function ($, window, document, undefined) {
...
initialize3 : (function ($, window, document, undefined) {
